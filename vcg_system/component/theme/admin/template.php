		...
		<div>
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="tc_aside">
				...
				<div class="brand flex-column-auto" id="tc_brand">
					...
					<a href="index-2.html" class="brand-logo">
						<img class="brand-image" style="height: 25px;" alt="Logo" src="<?php echo $theme->assetPath; ?>/images/misc/k.png" />
						<span class="brand-text"><img style="height: 25px;" alt="Logo"
							src="<?php echo $theme->assetPath; ?>/images/misc/logo.png" /></span>
...
<div class="dropdown">
	...
	<div class="topbar-item" data-toggle="dropdown" data-display="static">
		<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
			...
			src="<?php echo $theme->assetPath; ?>/images/svg/flags/226-united-states.svg" alt="" />
		</div>
	</div>
...
<script src="<?php echo $theme->assetPath; ?>/api/apexcharts/apexcharts.js"></script>
<script src="<?php echo $theme->assetPath; ?>/api/apexcharts/scriptcharts.js"></script> 
...
<script src="<?php echo $theme->assetPath; ?>/api/quill/quill.min.js"></script>
<script src="<?php echo $theme->assetPath; ?>/api/datatable/jquery.dataTables.min.js"></script>

...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2022 at 07:18 PM
...
(7, 'ripcris', 'ZFDu2KUTOY0pe9WJj7yzsA==', 'W6cIaZUzJGIRontE', 'test customer', NULL, NULL, 'ripcris10@gmail.com', '11111111', 'Bacolod');
...
(1, 7, '[{\"product_id\":\"1\",\"transaction\":{\"id\":\"1\",\"quantity\":3,\"subtotal\":4767,\"price\":\"1589.00\"},\"info\":{\"brand\":\"rstone\",\"category\":\"rstone\",\"product_name\":\"185 r14\",\"product_price\":\"1589.00\"}},{\"product_id\":\"2\",\"transaction\":{\"id\":\"2\",\"quantity\":2,\"subtotal\":3300,\"price\":\"1650.00\"},\"info\":{\"brand\":\"rstone\",\"category\":\"rstone\",\"product_name\":\"185 r15\",\"product_price\":\"1650.00\"}},{\"product_id\":\"6\",\"transaction\":{\"id\":\"6\",\"quantity\":1,\"subtotal\":\"2050.00\",\"price\":\"2050.00\"},\"info\":{\"brand\":\"leao-china\",\"category\":\"leao-china\",\"product_name\":\"155 r12\",\"product_price\":\"2050.00\"}}]', 'processing');
...
--
-- Table structure for table `vgc_customer_wishlist`
--

CREATE TABLE `vgc_customer_wishlist` (
  `id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  ...
  `transaction_type` varchar(500) NOT NULL DEFAULT 'online',
...
(4, 'ca', 'Y4sWkRKVicC8F6qliodQjQ==', '9rLLXVnNTNVDCbgy', 'cashier', 'cashier', 'cashier');

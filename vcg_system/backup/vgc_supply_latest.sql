...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2775576833ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_transaction">`vgc_supply`.`vgc_transaction`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_product_stock">`vgc_supply`.`vgc_product_stock`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_customer_shipping_address">`vgc_supply`.`vgc_customer_shipping_address`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_customer">`vgc_supply`.`vgc_customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_category">`vgc_supply`.`vgc_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_product_sale">`vgc_supply`.`vgc_product_sale`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_product_inventory">`vgc_supply`.`vgc_product_inventory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vgc_supply&table=vgc_brand">`vgc_supply`.`vgc_brand`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wxw&table=wxw">`wxw`.`wxw`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mic&table=mic">`mic`.`mic`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4b384f382f432e69525e52766b25384a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="vgc_supply" targettable="vgc_transaction">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vgc_transaction`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_transaction">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `customer` FROM `vgc_transaction` WHERE `vgc_transaction`.`id` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_transaction">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vgc_transaction`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_product_stock">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vgc_product_stock`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_transaction">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `selectedProduct` FROM `vgc_transaction` WHERE `vgc_transaction`.`id` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_transaction">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vgc_transaction`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_customer_shipping_address">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vgc_customer_shipping_address`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vgc_supply" targettable="vgc_transaction">
                            <div class="action_content">

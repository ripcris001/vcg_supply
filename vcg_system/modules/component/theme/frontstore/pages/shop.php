                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-1.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Brandix Rim 17 Inci</a>
                                </h3>
                                <div class="rating">
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-2.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Brandix Wheel</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-3.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Automotive Motor Filter</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-4.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Auto Parts Accessories</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-5.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Aluminum Wheels Concave Rim</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-6.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Car Seat</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-7.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Lubricant Oil</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-8.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Auto Parts Body Accessories</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="shop-item-box">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-3">
                            <div class="shop-image">
                                <a href="products-details.html">
                                    <img src="<?php echo $theme->assetPath.'/img/shop/shop-9.png'; ?>" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="shop-content">
                                <h3>
                                    <a href="products-details.html">Auto Parts Steering Wheel</a>
                                </h3>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>

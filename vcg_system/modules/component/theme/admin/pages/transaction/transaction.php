                        ...
                        dataSrc: function(source){
                            ...
                            if(count){
                                for(let a = 0; a < count; a++){
                                    ...
                                    loopdata.overall_total = utils.currency(loopdata.overall_total);
                                    loopdata.nAction = `
                                    <div class="text-center align-items-center">
                                        <a class="badge bg-info mr-2 tbl-action" data-action="view-transaction" href="javascript:void(0)">
            ...
            event: function(){
                ...
                $('table').on('click', 'tr td .tbl-action', function() {
                    ...
                    if(action == 'view-transaction'){
                        ...
                        console.log(tdata);
                        window.location.href = `/admin/transaction/view?transaction=${tdata.transaction_id}`;
                    } 
                })
            }
        }

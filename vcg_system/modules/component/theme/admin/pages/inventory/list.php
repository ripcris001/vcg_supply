...
$(document).ready(function() {
    ...
    const brand = {
                    ...
                    dataSrc: function(source) {
                        ...
                        if (count) {
                            for (let a = 0; a < count; a++) {
                                ...
                                loopdata.brand_id =
                                    `<div class="text-center">${loopdata.brand_id}</div>`;
                                loopdata.nAction = `
                                        <a class="badge bg-info mr-2 btn-view-po" title="edit" href="javascript:void(0)">
                                            <i class="ri-eye-line mr-0"></i>
                                        </a>
                                        <a class="badge bg-danger mr-2 btn-print clickable" data-id="${loopdata.id}" title="Print">
                                            <i class="las la-print mr-0"></i>
                                        </a>                                                  
                                    ${createLoginAccount}
                                    `;
        ...
        event: function() {
            const __self = this;
            $(__self.table.main).on('click', ".btn-print", function() {
                const local = $(this);
                const data = local.data('id');
                window.open(`/admin/inventory/print?purchase_order=${data}`,

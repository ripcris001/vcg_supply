        ...
        <div class="card card-block card-stretch card-height print rounded">
            <div class="card-header d-flex justify-content-between bg-primary header-invoice">
                <div class="iq-header-title">
                    <h4 class="card-title mb-0">Purchase Order # <span class="transaction-info"
                            data-action="po_number"></span></h4>
                </div>
                <div class="invoice-btn">
                    <button type="button" class="btn btn-primary-dark mr-2 btn-print"><i class="las la-print"></i>
                        Print</button>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="badge badge-danger transaction-info"
                                                data-action="status">Unpaid</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    const transaction = {
            ...
            find.each(function(i) {
                ...
                if (Object.keys(transaction).indexOf(action) > -1) {
                    if (currencyData.indexOf(action) > -1) {
                        ...
                        if (action == 'note') {
                            local.html(transaction[action] && transaction[action].length ?
                                transaction[action] : "No notes.");
                        } else {
        ...
        event: function() {
            ...
            $('.btn-print').click(function() {
                ...
                window.open(`/admin/inventory/print?purchase_order=${data.id}`,
                    '_blank', 'location=yes,height=700,width=1000,scrollbars=yes,status=yes'
                )
            })
        }
    }

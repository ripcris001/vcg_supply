            ...
            <div class="col-md-3 pl-0">
                <div class="form-group">
                    <select name="product_category" id="product_category"
                        class="form-control product_category select-product-filter" data-style="py-0"></select>
                </div>
            </div>
        </div>
    </div>
            ...
            return new Promise((resolve, reject) => {
                ...
                if (mainData.length) {
                    ...
                    for (let a = 0; a < count; a++) {
                        ...
                        html +=
                            `<option value="${loopdata[data.index]}">${loopdata[data.value]}</option>`;
                        if (a == (count - 1)) {
                    ...
                    dataSrc: function(source) {
                        ...
                        if (count) {
                            for (let a = 0; a < count; a++) {
                                ...
                                loopdata.display_price = utils.currency(loopdata
                                    .product_price);

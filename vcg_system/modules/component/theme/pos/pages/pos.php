                                    ...
                                    <label class="text-dark d-flex">Choose a Customer
                                        <span class="badge badge-secondary white rounded-circle" data-toggle="modal"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-sm"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_122"
                                ...
                                <div class="d-flex flex-column selectmain">
                                    <label class="text-dark d-flex">Shipping Address
                                        <span class="badge badge-secondary white rounded-circle btn-add-shipping">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-sm"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_21"
                                                x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512"
                                                enable-background="new 0 0 512 512" xml:space="preserve">
                                                <g>
                                                    <rect x="234.362" y="128" width="43.263" height="256"></rect>
                            ...
                            <table class="table right-table">
                                <tbody>
                                    <tr class="d-flex align-items-center justify-content-between">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base transaction_total_item transaction_entry pb-0">
                                            0</td>
                                    ...
                                    <tr class="d-flex align-items-center justify-content-between">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base transaction_sub_total transaction_entry currency pb-0">
                                            0</td>
                                    ...
                                    <tr class="d-flex align-items-center justify-content-between">
                                        ...
                                        <td class="border-0 justify-content-end d-flex text-dark font-size-base"><span
                                                class="transaction_entry transaction_discount pb-0">0</span>%</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between">
                                        <th class="border-0 font-size-h5 mb-0 font-size-bold text-dark pb-0">
                                            Discount Amount
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base transaction_entry transaction_discount_amount currency pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between">
                                        <th class="border-0 font-size-h5 mb-0 font-size-bold text-dark pb-0">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base transaction_entry transaction_additional_discount currency pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between">
                                        <th class="border-0 pb-0">
                                            <div
                                                ...
                                                Shipping Cost
                                                <span
                                                    class="badge badge-secondary white rounded-circle ml-2 btn-shipping-cost">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="svg-sm"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                        id="Layer_11" x="0px" y="0px" width="512px" height="512px"
                                                        viewBox="0 0 512 512" enable-background="new 0 0 512 512"
                                                        xml:space="preserve">
                                                        <g>
                                                            <rect x="234.362" y="128" width="43.263" height="256">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base text-primary font-size-base transaction_entry transaction_shipping_cost currency pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between">
                                        <th class="border-0 font-size-h5 mb-0 font-size-bold text-dark pb-0">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base transaction_entry transaction_taxable currency pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between seperator">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-dark font-size-base transaction_entry transaction_tax currency">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between item-price ">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-primary font-size-base transaction_entry transaction_cash_payment currency  pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between item-price seperator">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-primary font-size-base transaction_entry transaction_card_payment currency">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between item-price ">
                                        <th class="border-0 font-size-h5 mb-0 font-size-bold text-primary pb-0">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-primary font-size-base transaction_entry transaction_overall_total currency pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between item-price ">
                                        <th class="border-0 font-size-h5 mb-0 font-size-bold text-primary pb-0">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-primary font-size-base transaction_entry transaction_total_payment currency pb-0">
                                            0</td>
                                    </tr>
                                    <tr class="d-flex align-items-center justify-content-between item-price ">
                                        <th class="border-0 font-size-h5 mb-0 font-size-bold text-primary">
                                        ...
                                        <td
                                            class="border-0 justify-content-end d-flex text-primary font-size-base transaction_entry transaction_amount_balance currency">
                                            0</td>
                                    </tr>
                ...
                <table class="table right-table">
                    <tbody>
                        <tr class="d-flex align-items-center justify-content-between">
                            ...
                            <td
                                class="border-0 justify-content-end d-flex text-primary font-size-lg font-size-bold px-0 font-size-lg mb-0 font-size-bold text-primary transaction_entry transaction_overall_total currency">
                                0
                            </td>
                        </tr>
                        <tr class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="number" class="form-control payment_input" min="0"
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <fieldset class="form-label-group ">
                                <textarea class="form-control fixed-size input_remarks" id="horizontalTextarea" rows="5"
                ...
                <form class="add-customer-shipping-address">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <select
                                    class="js-example-basic-single js-states form-control bg-transparent  p-0 border-0 form-input"
                                    name="country">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="js-states form-control bg-transparent p-0 border-0 select-address form-input"
                                name="province">
                            </select>
                            </fieldset>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group mb-3">
                                <select
                                    class="js-states form-control bg-transparent p-0 border-0 select-address form-input"
                                    name="city">
                        ...
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="number" name="postal_code" class="form-control form-input"
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="street" class="form-control form-input"
                    ...
                    <div class="form-group row justify-content-end mb-0">
                        <div class="col-md-6  text-right">
                            ...
                            <button type="submit" class="btn btn-primary btn-action" data-action="submit">Add
                                Address</button>
                        </div>
                    </div>
                </form>
                ...
                <form class="add-customer">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="customer_name" class="form-control form-input"
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="customer_company" class="form-control form-input"
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="customer_tax_no" class="form-control form-input"
                        ...
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="email" name="customer_email" class="form-control form-input"
                        ...
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="customer_phone_no" class="form-control form-input"
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="customer_address" class="form-control form-input"
...
<div class="modal fade text-left" id="folderpop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel14"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="myModalLabel14">Cart Orders</h3>
                <button type="button" class="close rounded-pill btn btn-sm btn-icon btn-light btn-hover-primary m-0"
                    data-dismiss="modal" aria-label="Close">
                    <svg width="20px" height="20px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <fieldset class="form-group mb-3 d-flex">
                            <input type="number" name="text" class="form-control bg-white input-discount"
                                placeholder="Enter Discount" max="100">
                            <a href="javascript:void(0)"
                                class="btn-secondary btn ml-2 white pt-1 pb-1 d-flex align-items-center justify-content-center btn-add-discount">Apply</a>
                        </fieldset>
                ...
                <form class="shipping-cost-form">
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="text" name="customer_name" class="form-control"
                                    placeholder="Enter Customer " value="David Jones" disabled>
                            </fieldset>
                        </div>
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <select
                                    class="js-states form-control bg-transparent p-0 border-0 select-shipping-cost-address form-input"
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <input type="number" name="shipping_charge" class="form-control form-input"
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label class="text-body">Note (if any)</label>
                            <fieldset class="form-label-group ">
                                <textarea class="form-control form-input" name="shipping_note" rows="5"
                    ...
                    <div class="form-group row justify-content-end mb-0">
                        <div class="col-md-6  text-right">
                            <button type="reset" class="btn btn-outline-primary btn-action"
                                data-action="cancel">Cancel</button>
                            <button type="submit" class="btn btn-primary btn-action" data-action="submit">Update
                                Order</button>
                        </div>
                    </div>
                </form>
...
jQuery(document).ready(function() {
    const main = {
        ...
        getCart: function(){
            ...
            utils.request.set({
                data: input,
                url: '/api/product/getprocesscart'
            }).send(function(res) {
                if (res.status) {
            ...
            if(cartdata.length){
                for(let a = 0, count = cartdata.length; a < count; a++){
                    ...
                    html += `<div class="col-lg-4">
                        <div class="pos-order">
                            <h3 class="pos-order-title">Cart ${local.cart_id}</h3>
                            <div class="orderdetail-pos">
                                <p>
                                    <strong>Customer Name:</strong>
                                    ${local.customer.info.customer_name}
                                </p>
                                <p>
                                    <strong>Email</strong>
                                    ${local.customer.info.customer_email}
                                </p>
                            </div>
                            <div class="d-flex justify-content-end">
                               
                                <a href="#" class="btn-load ml-3" title="Edit" data-id="${a}"><i
        ...
        addressProvinceEvent: function(data) {
            ...
            __self.loadSelect({
                data: addressData,
                tag: 'city',
                target: '.select-address[name=city]',
                title: 'Select City',
                index: 'index',
                value: 'value',
                onchange: 'addressCityEvent'
            })
        },
        addressCityEvent: function(data) {
            ...
            __self.loadSelect({
                data: addressData,
                tag: 'barangay',
                target: '.select-address[name=barangay]',
                title: 'Select Barangay',
                index: 'index',
                value: 'value',
                onchange: 'addressBarangayEvent'
            })
        },
        ...
        generateAddress: function() {
            ...
            __self.loadSelect({
                data: data,
                tag: 'province',
                target: '.select-address[name=province]',
                title: 'Select Province',
                index: 'index',
                value: 'value',
                onchange: 'addressProvinceEvent'
            });
            ...
            if (active_customer > -1) {
                ...
                if (!active_customer.address.length) {
                    utils.notify.setTitle("Error").setMessage(
                        `Customer [${active_customer.customer_name}] doesnt have shipping address! please add shipping address to continue!`
                    ).setType("danger").load();
                } else {
                    ...
                    for (let a = 0, count = active_customer.address.length; a < count; a++) {
                        ...
                        let new_address =
                            `${loopdata.street} ${loopdata.barangay}, ${loopdata.city}, ${loopdata.province}`
                        new_address = new_address.toLowerCase();
                        new_shipping_address.push({
                            index: `${loopdata.shipping_id}`,
                            value: new_address
                        })
                        if (a == (count - 1)) {
                            jQuery('.shipping-cost-form').find('input[name=customer_name]').val(
                                active_customer.customer_name);
                            __self.loadSelect({
                                data: new_shipping_address,
                                tag: 'shipping_address',
                                target: '.select-shipping-cost-address[name=shipping_address]',
                ...
                utils.notify.setTitle("Error").setMessage("Customer not register!").setType("danger")
                    .load();
            }
        },
        customerEvent: function(data) {
            ...
            if (customer > -1) {
                ...
                if (data.value == "walkin") {
                    ...
                    utils.notify.setTitle("Error").setMessage("Customer not register!").setType(
                        "danger").load();
                }
            }
        },
            ...
            utils.request.set({
                ...
                if (res.status) {
                    ...
                    __self.loadSelect({
                        data: res.data,
                        tag: 'customer',
                        target: '.select-customer[name=customer]',
                        title: 'Walk in Customer',
                        index: 'customer_id',
                        value: 'customer_name',
                        default_value: 'walkin',
                        onchange: 'customerEvent'
                    })
                }
            })
        },
        ...
        getProduct: function(param = {}) {
            const __self = this;
            utils.request.set({
                data: Object.keys(param).length > 0 ? param : {},
                url: '/api/product'
            }).send(function(res) {
                if (res.status) {
        ...
        loadSelect: function(param) {
            ...
            if (param.data) {
                ...
                const input = [{
                    text: `<span class="capitalize">${param.title}</span>`,
                    value: param.default_value ? param.default_value : 'all',
                    selected: true
                }]
                ...
                if (param.data.length) {
                    for (let a = 0; a < count; a++) {
                        ...
                        input.push({
                            text: `<span class="capitalize">${loopdata[param.value]}</span>`,
                            value: loopdata[param.index]
                        })
                        if (a == (count - 1)) {
                            ...
                            __self.multiselect[param.tag] = jQuery(param.target).multipleSelect({
                                ...
                                onClick: function(onclickParam) {
                                    if (param.tag) {
                                        switch (param.tag) {
                                            case "brand":
                                                __self.onChangeBrand(onclickParam);
                                                break;
                                            case "category":
                                                __self.onChangeCategory(onclickParam);
                                                break
                                            default:
                                                Object.keys(param).indexOf('onchange') > -
                                                    1 ? __self[param.onchange](
                            ...
                            if (param.tag) {
                                switch (param.tag) {
                                    ...
                                    case "category":
                                        ...
                                        break
                                    default:
                                        param.onchange ? __self[param.onchange](
                                            onclickParam) : function() {};
                                        break;
                                }
                            }
        ...
        event: function() {
            ...
            jQuery('.product-items').on('click', '.product-data', function() {
                const local = jQuery(this);
                if (!local.hasClass('sold_out')) {
                    jQuery('.product-items').find('.active-product').removeClass(
                        'active-product');
            ...
            jQuery('.modal').on('submit', '.add-customer', function(e) {
                ...
                if (err) {
                    utils.notify.setTitle("Error").setMessage(
                        "Please fill in the require field!").setType("danger").load();
                } else {
                    utils.request.set({
                        data: input,
                        ...
                        if (res.status) {
                            utils.notify.setTitle("Success").setMessage(res.message)
            ...
            jQuery('.btn-add-shipping').click(function() {
                ...
                if (customer.customer_id) {
                    ...
                    utils.notify.setTitle("Error").setMessage("Select a customer first!")
                        .setType("danger").load();
                }
            })
    ...
    const transaction = {
        ...
        data: {
            ...
            currencyData: ['sub_total', 'discount_amount', 'additional_discount', 'tax', 'overall_total',
                'total_payment', 'taxable', 'shipping_cost', 'cash_payment', 'amount_balance'
            ]
        },
        datatable: {
            main: null
        ...
        addSelectedProduct: function(data) {
            ...
            if (Object.keys(data).length) {
                const findID = utils.findObjectIndex(__self.data.transaction.selectedProduct,
                    "product_id", data.product_id);
                if (findID > -1) {
                    utils.notify.setTitle("Error").setMessage("Product Already added").setType("danger")
                        .load();
                } else {
                    if (data.remaining_stock <= 0) {
                        utils.notify.setTitle("Error").setMessage(
                            `Product [<span class="capitalize">${data.product_name}</span>] out of stock!`
                        ).setType("danger").load();
                    } else {
                        data.transaction = {
                            id: data.product_id,
        ...
        removeSelectedProduct: function(data, target) {
            const __self = this;
            const selectedProduct = __self.data.transaction.selectedProduct.length ? __self.data
        ...
        event: function() {
            ...
            jQuery(s.table.main).on('input', 'tr td .input-quantity', function() {
                ...
                if (tdata.id) {
                    console.log(s.data);
                    const product_id = utils.findObjectIndex(s.data.transaction.selectedProduct,
                        "product_id", tdata.id);
                    if (product_id > -1) {
                        ...
                        s.data.transaction.selectedProduct[product_id].transaction.quantity =
                            value;
                        s.data.transaction.selectedProduct[product_id].transaction.subtotal =
                            subtotal;
                ...
                if (value) {
                    ...
                    if (value < 0) {
                        ...
                        utils.notify.setTitle("Success").setMessage(
                            "Sucessfully added discount").setType("success").load()
                    } else {
            ...
            jQuery('#payment-popup').on('submit', '.payment-method', function(e) {
                ...
                if (value.length) {
                    ...
                    const checkPayment = utils.findObjectIndex(transaction.payment, "mode",
                        payment_type);
                    if (checkPayment > -1) {
                        s.data.transaction.payment[checkPayment].amount = parseFloat(value);
                    } else {
                        s.data.transaction.payment.push({
                            amount: value,
                            mode: payment_type,
                            remarks: ""
                        });
            ...
            jQuery('.btn-payment-modal').click(function() {
                ...
                if (selectedProduct.length) {
                    ...
                    utils.notify.setTitle("Warning").setMessage("Please add product first!")
                        .setType("warning").load();
                }
            })
                    ...
                    if (balance <= 0) {
                        ...
                        if (transaction.transaction_type == 'delivery' && !transaction.shipping.shipping_id) {
                            ...
                            if (transaction.selectedProduct.length) {
                                Swal.fire({
                                    ...
                                    if (sw.value) {
                                        transaction.transaction_type = transaction
                                            .customer.status;
                                        for (let a = 0, count = transaction
                                                .selectedProduct.length; a <
                                            count; a++) {
                                            const infoList = ['brand', 'category',
                                                'product_name', 'product_price'
                                            ]
                                            const productID = utils.findObjectIndex(main
                                                .data.product, 'product_id',
                                                transaction.selectedProduct[a]
                                                .product_id);
                                            const productData = main.data.product[
                                                productID];
                                            transaction.selectedProduct[a] = {
                                            ...
                                            if (a == (count - 1)) {
                                                ...
                                                transaction.customer = JSON.stringify(
                                                    transaction.customer);
                                                transaction.payment = JSON.stringify(
                                                    transaction.payment);
                                                transaction.shipping = JSON.stringify(
                                                    transaction.shipping);
                                                transaction.selectedProduct = JSON
                                                    ...
                                                    if (res.status) {
                                                        swal({
                                                            ...
                                                            main
                                                                .reloadProductList();
                                                            s.print(
                                                                `/pos/print/transaction?transaction_id=${res.transaction_id}`
                                                            )
                                                        })
                                                    } else {
                                                        swal({
                                ...
                                utils.notify.setTitle("Warning").setMessage(
                                    "Please add product first!").setType("warning").load();
                            }
                        }
                    } else {
                        utils.notify.setTitle("Warning").setMessage(
                                "Please settle your remaining balance!").setType("danger")
                            .load();
                    }
                } else {
                    utils.notify.setTitle("Warning").setMessage("Please add product first!")
                ...
                local.find('.form-input').each(function(elem) {
                    ...
                    if (typeof name !== 'undefined') {
                        if (name == 'shipping_address') {
                            const selectID = jQuery(
                                '.select-shipping-cost-address[name=shipping_address]'
                            ).multipleSelect('getSelects')
                            let selectValue = jQuery(
                                '.select-shipping-cost-address[name=shipping_address]'
                    ...
                    if (elem == (elemCount - 1)) {
                        ...
                        s.data.transaction.shipping_cost = input.shipping_charge ?
                            parseFloat(input.shipping_charge) : 0;
                        s.generateTotal();
                        local.trigger('reset');
        ...
        generateTotal: function() {
            ...
            transaction.discount_amount = __self.calculateDiscount(transaction.sub_total, transaction
                .discount);

            // calculate overall
            transaction.overall_total = (transaction.sub_total + transaction.shipping_cost) - (
                transaction.discount_amount + transaction.additional_discount);
            ...
            for (let a = 0, count = tObj.length; a < count; a++) {
                ...
                jQuery('.transaction-summary').find(`.transaction_entry.transaction_${index}`).html(
                    currencyValue.indexOf(index) > -1 ? utils.currency(transaction[index]) :
                    transaction[index]
                );
